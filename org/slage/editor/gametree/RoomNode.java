 ...
 * represents an <b>Room</b> in the game.
 * 
 * @author Jared Cope
 */
public class RoomNode
	...
	/**
	 * Constructs this node with the <i>Room</i> that it represents, and the
	 * <i>tree</i> that this node will be part of. The <i>editor</i> is used to
	 * handle any actions for this node.
	 * 
	 * @param aRoom the room that this node represents
	 * @param aTree the tree that this node is part of
	 * @param editor used to react to actions generated on this node
	 */
	public RoomNode(Room aRoom, JTree aTree, Editor editor) {
		super(aRoom.getName());
		this.room = aRoom;
		this.tree = aTree;

		createPopupMenu(aRoom.getName(), editor);
	}

	/**
	 * Constructs this node with a new Room that it will represent.
	 * 
	 * @param title the title for the new room
	 * @param aTree the tree that this node is part of
	 * @param editor used to react to actions generated on this node
	 */
	public RoomNode(String title, JTree aTree, Editor editor) {
		super(title);
		this.tree = aTree;
	...
	/**
	 * Returns the Room that this node represents.
	 * 
	 * @return the Room that this node represents
	 ...
	 * may safely cast the returned object to an instance of <b>org.slage.Room</b>
	 ...
	 * </ul>
	 * 
	 * @param roomName a name that can be used to customize the menu
	 * @param editor used to react to actions generated on this menu
	 */
	public void createPopupMenu(String roomName, Editor editor) {
		menu = new JPopupMenu();
		menu.add(new JLabel(" Menu for - " + roomName));
