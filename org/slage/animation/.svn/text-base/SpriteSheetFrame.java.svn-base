...
/**
 * A frame of animation that uses one overarching sprite sheet
 * 
...
public class SpriteSheetFrame
	...
	/**
	 * Creates a new instance of SpriteSheetFrame
	 * 
	 * @param rect the source rectangle on the sprite sheet
	 * @param parent the parent Animation
	 */
	public SpriteSheetFrame(java.awt.Rectangle rect, SpriteSheetAnimation parent) {
		super(rect, parent);
	}
	...
	public void draw(java.awt.Graphics2D G2D, Point3D P3D) {
		SlageImage imgSprite = ((SpriteSheetAnimation) getParent()).getSpriteSheet();
