...
/**
 * UPDATE Handler: Updates the CollisionStatus of all objects in the scene.
...
public class TestCollisionHandler
	...
	/**
	 * Creates a new instance of TestCollisionHandler
	 * 
	 * @param game SlageGame to track
	 */
	public TestCollisionHandler(org.slage.SlageGame game) {
		super(game);
	}
